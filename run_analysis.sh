...
# Устанавливаем зависимости с подавлением предупреждений
echo "Устанавливаем зависимости..."
pip3 install --quiet --disable-pip-version-check -r requirements.txt 2>/dev/null || {
    echo "Попытка установки с альтернативными флагами..."
    pip3 install --quiet -r requirements.txt
}

# Запускаем анализ с переданными аргументами
echo "Запускаем анализ позиции..."
python3 uniswap_analyzer.py $PYTHON_ARGS
